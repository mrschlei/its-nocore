...
<?php if($output) { ?><span class="views-label views-label-field-tp-its-cost">ITS Cost:</span> <?
include_once("/afs/umich.edu/group/i/itsdrupl/Public/html/sites/default/ociloader.php");
ociquery("doRate",$row->field_field_voip_its_item_number_1[0]["rendered"]["#markup"]);
}
?>
